...
def CapsNet(input_shape, n_class, num_routing):
    ...
    train_model = models.Model([x, y], [digitcaps, out_caps, decoder(masked_by_y)])
    eval_model = models.Model(x, [digitcaps, out_caps, decoder(masked)])
...
if __name__ == "__main__":
    ...
    if args.is_training:
        ...
        for i in xrange(0,10):
            test(model=model, data=(x_test, y_test),sample=i)
