...
def test(model, data):
    ...
    image = img * 255
    Image.fromarray(image.astype(np.uint8)).save("real_and_recon_mnist.png")
    print()
    print('Reconstructed images are saved to ./real_and_recon_mnist.png')
    print('-'*50)
    plt.imshow(plt.imread("real_and_recon_mnist.png", ))
    plt.show()
